...
const zhCN: Messages = {
  ...
  'snippets.action.newPackage': '新建 Package',
  ...
  'snippets.field.package': '添加 Package',
  'snippets.field.packagePlaceholder': '选择或创建 Package',
  'snippets.field.createPackage': '创建 Package',
  ...
  'snippets.history.emptyTitle': '暂无 Shell History',
  ...
  'snippets.breadcrumb.allPackages': '全部 Packages',
  ...
  'snippets.packageDialog.title': '新建 Package',
  ...
  'snippets.packageDialog.hint': '使用 "/" 创建嵌套 Package。',
};
