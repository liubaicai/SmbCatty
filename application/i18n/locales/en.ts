...
const en: Messages = {
  ...
  'pf.type.dynamic.desc': 'Dynamic port forwarding turns SmbCatty into a SOCKS proxy server.',
  ...
  'cloudSync.githubFlow.desc': 'Copy the code below and enter it on GitHub to authorize SmbCatty.',
